...
System.register(["./patch"], function (_export, _context) {
    "use strict";

    var JsonPatch, _typeof, JsonDecoder;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("JsonDecoder", JsonDecoder = function () {
                ...
                JsonDecoder.prototype.diff = function diff(target) {
                    ...
                    var patch = arguments.length <= 2 || arguments[2] === undefined ? new JsonPatch() : arguments[2];
